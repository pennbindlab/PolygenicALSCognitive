...
Plot wPRS scores for the CReATe cohort relative to noLD_wPRS scores (Supplementary Figure 7).
```{r Supplementary_Figure_7}
...
pdf("Supplementary_Figure_7.pdf")
plot1
dev.off()
```
...
Create a heatmap to visualize beta weights for the fixed effect of each SNP on each clinical variable (Supplementary Figure 8A).
```{r Supplementary_Figure_8A}
...
Combine Supplementary Figure 8A and Supplementary Figure 8B into a single PDF.
```{r Supplementary_Figure_8}
pdf("Supplementary_Figure_8.pdf")
ggarrange(plot4,
          plot5, 
          nrow = 2
          ) 
